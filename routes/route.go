...
func NewSavedthreadControllers(e *echo.Group) {
	e.GET("/savedthreads", controller.GetSavedthreadController)
	e.GET("/savedthreads/:id", controller.GetSavedthreadsIDController)
	e.POST("/savedthreads", controller.CreateSavedthreadsController)
	e.DELETE("/savedthreads/:id", controller.DeleteSavedthreadsController)
	e.PUT("/savedthreads/:id", controller.UpdateSavedthreadsController)
}
